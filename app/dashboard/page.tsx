  ...
  return (
    <main className="max-w-5xl mx-auto px-5 py-12">
      ...
      <div className="flex items-start justify-between mb-10 flex-wrap gap-4">
        ...
        <Link
          href="/"
          className="flex items-center gap-2 text-sm bg-[#00c27a] hover:bg-[#00a868] transition-colors px-4 py-2.5 rounded-xl font-semibold text-white active:scale-95"
        >
      ...
      {imagesWithUrls.length === 0 ? (
        <div className="text-center py-24 border-2 border-dashed border-gray-200 rounded-2xl">
          <div className="w-14 h-14 rounded-2xl bg-[#e6fff5] flex items-center justify-center mx-auto mb-4">
            <svg className="w-7 h-7 text-[#00c27a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link href="/" className="text-[#00c27a] hover:text-[#00a868] text-sm font-semibold transition-colors">
              ...
              <div className="p-3">
                ...
                {img.processedUrl && (
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-xs text-[#00c27a] hover:text-[#00a868] transition-colors font-semibold"
                  >
